...
elif dice_list[0] != dice_list[1] and dice_list[1] != dice_list[2] and dice_list[0] != dice_list[2]:
    print(100 * max(dice_list[0], dice_list[1], dice_list[2]))
       
elif dice_list[0] == dice_list[1] and dice_list[1] != dice_list[2]:
    print(1000 + dice_list[1] * 100)
        
elif dice_list[0] != dice_list[1] and dice_list[1] == dice_list[2]:
    print(1000 + dice_list[1] * 100)
        
elif dice_list[0] == dice_list[2] and dice_list[2] != dice_list[1]:
